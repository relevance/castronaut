...
describe Castronaut::Models::ProxyGrantingTicket do
  ...
  describe "dispensing a ticket" do
    ...
    it "starts with PGT" do
      Castronaut::Models::ProxyGrantingTicket.new.send(:dispense_ticket).starts_with?("PGT").should be_true
    end
    
    it "is 64 characters long" do
      Castronaut::Models::ProxyGrantingTicket.new.send(:dispense_ticket).size.should == 64
    end
    ...
    it "uses the random string generation for the remaining 60 characters" do
      ...
      Castronaut::Models::ProxyGrantingTicket.new.send(:dispense_ticket)
    end
  ...
  describe "dispensing an iou" do
    ...
    it "starts with PGTIOU" do
      Castronaut::Models::ProxyGrantingTicket.new.send(:dispense_iou).starts_with?("PGTIOU").should be_true
    end
    
    it "is 64 characters long" do
      Castronaut::Models::ProxyGrantingTicket.new.send(:dispense_iou).size.should == 64
    end
    ...
    it "uses the random string generation for the remaining 57 characters" do
      ...
      Castronaut::Models::ProxyGrantingTicket.new.send(:dispense_iou)
    end
  ...
  describe "generating a proxy granting ticket" do
    ...
    it "attempts to parse the given url with URI.parse" do
      ...
      Castronaut::Models::ProxyGrantingTicket.generate_ticket('http://pgturl', '10.1.1.1', 'service ticket')
    end
    ...
    describe "when proxy granting ticket url is invalid it returns a ticket result" do
      ...
      it "with a message indicating it was unable to parse the given url" do
        URI.expects(:parse).with('http://pgturl').raises(URI::InvalidURIError)
        Castronaut::Models::ProxyGrantingTicket.generate_ticket('http://pgturl', '10.1.1.1', 'service ticket').message.should == "Unable to parse pgt_url 'http://pgturl'"
      end
      
      it "with a message category of warn" do
        URI.expects(:parse).with('http://pgturl').raises(URI::InvalidURIError)
        Castronaut::Models::ProxyGrantingTicket.generate_ticket('http://pgturl', '10.1.1.1', 'service ticket').message_category.should == 'warn'
      end
    ...
    describe "when proxy granting ticket url is valid" do
      ...
      it "creates a new net/http connection to uri host and port" do
        ...
        Castronaut::Models::ProxyGrantingTicket.generate_ticket('http://example.com', '10.1.1.1', 'service ticket')
      end
      ...
      describe "inside the http connection block" do
        ...
        it "intializes a new proxy granting ticket" do
          ...
          Castronaut::Models::ProxyGrantingTicket.expects(:new).with(:service_ticket => 'service ticket', :client_hostname => '10.1.1.1').returns(stub_everything)
          Castronaut::Models::ProxyGrantingTicket.generate_ticket('http://example.com', '10.1.1.1', 'service ticket')
        end
        ...
        it "dispenses a new ticket for the proxy granting ticket" do
          ...
          Castronaut::Models::ProxyGrantingTicket.stubs(:new).returns(proxy_granting_ticket)
        ...
        it "requests the proxy granting ticket path via GET" do
          ...
          Castronaut::Models::ProxyGrantingTicket.stubs(:new).returns(stub_everything(:iou => 'PGTIOU-RANDOM', :ticket => 'PGT-RANDOM'))
        ...
        describe "when the request to the proxy granting ticket path is successful" do
          ...
          describe "returns a ticket result" do
            ...
            it "with the proxy granting ticket" do
              ...
              Castronaut::Models::ProxyGrantingTicket.generate_ticket('http://example.com', '10.1.1.1', 'service ticket').ticket.should == proxy_granting_ticket
            end
            ...
            it "with a proxy granting ticket generated message" do
              ...
              Castronaut::Models::ProxyGrantingTicket.generate_ticket('http://example.com', '10.1.1.1', 'service ticket').message.should == "PGT generated for pgt_url 'http://example.com': PGT-INSPECT"
            end
            ...
            it "with a message category of success" do
              ...
              Castronaut::Models::ProxyGrantingTicket.generate_ticket('http://example.com', '10.1.1.1', 'service ticket').message_category.should == 'success'
            end
        ...
        describe "when the request to the proxy granting ticket path has failed" do
           ...
           describe "returns a ticket result" do
              ...
              it "with a proxy granting ticket generated message" do
                ...
                Castronaut::Models::ProxyGrantingTicket.generate_ticket('http://example.com', '10.1.1.1', 'service ticket').message.should == "PGT callback server responded with a bad result code '404'. PGT will not be stored."
              end
              ...
              it "with a message category of success" do
                ...
                Castronaut::Models::ProxyGrantingTicket.generate_ticket('http://example.com', '10.1.1.1', 'service ticket').message_category.should == 'warn'
              end
